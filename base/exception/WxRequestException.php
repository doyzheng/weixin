...
class WxRequestException extends BaseException
{
     ...
     * @return mixed|string
     */
    public static function code2Message($code)
    {
        return isset(static::$codeDescription[$code]) ? static::$codeDescription[$code] : '';
    }
    
    /**
     * WeixinErrorCode constructor.
